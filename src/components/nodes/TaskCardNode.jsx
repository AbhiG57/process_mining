...
export default function TaskCardNode({ data }) {
  return (
    <div className="rounded dark:bg-slate-700 border dark:border-slate-500 shadow p-2 min-w-[100px] flex flex-col gap-1 relative bg-slate-100 border-slate-300">
