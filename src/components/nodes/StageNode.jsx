...
export default function StageNode({ data, selected }) {
  return (
    <div className="flex flex-col rounded-lg bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 shadow-lg p-3 min-w-[180px] min-h-[90px] relative text-xs w-full h-full">
